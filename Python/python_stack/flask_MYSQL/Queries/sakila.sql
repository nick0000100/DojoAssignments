...
SELECT customer.first_name, customer.last_name, customer.email, customer.email
FROM customer
...
SELECT CONCAT(first_name, ' ', last_name) AS actor_name, film_actor.last_update, film.title
FROM film
